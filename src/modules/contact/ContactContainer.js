                            ...
                            return (
                                <View
                                    ...
                                    <View style={[general.marginLeft, general.wrapperCenterLeftToRightColumn]}>
                                        ...
                                        <Text style={general.textDescriptionCard}> Số điện thoai: <TouchableOpacity  style ={{height : 10, width : 100}}><Text style = {{color : 'blue'}}>{item.phoneNumber}</Text></TouchableOpacity></Text>
                                    </View>
                                </View>
                            )
                        }
